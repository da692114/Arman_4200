...
using Arman_4200.Models;
using MIS4200Luce.DAL;
...
namespace Arman_4200.Controllers
{
    public class CourseDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "coursedetailID,description,courseDate,courseID")] CourseDetail courseDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "coursedetailID,description,courseDate,courseID")] CourseDetail courseDetail)
        {
            if (ModelState.IsValid)
            {
